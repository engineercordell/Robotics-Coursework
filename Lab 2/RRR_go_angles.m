...
%**************************************************************************
theta_constraint{1} = [ -141 135 ]; % [deg]
theta_constraint{2} = [ -139 135 ]; % [deg]
theta_constraint{3} = [ -139 137 ]; % [deg]
%**************************************************************************
...
dxl_SetVel(254,25)
dxl_SetPos(1, theta(1))
dxl_SetPos(2, theta(2))
dxl_SetPos(3, theta(3))
